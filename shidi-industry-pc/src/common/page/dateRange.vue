...
<template>
  <div class="dateRangeBox hh-css" style="display: flex">
    ...
    <dateYearRange v-else @input="timeDate" :value="dateRangeSon" :circleClose="circleClose" ref="dateYearRange" :haveDataTime="haveDataTime"/>
    <!-- <el-date-picker
      style="width: 100px"
      v-model="startDate"
      :type="datePickType"
      :placeholder="`选择开始${getPickerType}份`"
      :picker-options="startDatePickerOptions"
      :value-format="rangeFormat"
      @change="startChange"
      popper-class="datePickerDrop"
    > -->
  </div>
