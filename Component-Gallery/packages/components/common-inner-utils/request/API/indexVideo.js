import { $v, urlBis } from '../../funCommon/commonVideo'
...
// 无人机详情
// /forestry-baseservice/uavHorn/qryUavDeviceInfo/{deviceCode}
export function forestryQryUavDeviceInfo(data) {
  return request({
    vue: this,
    url: '/video-forestry-baseservice/uavHorn/qryUavDeviceInfo',
    method: 'post',
    data
  })
}
...
export function getUavDevicesBySiteCode(data) {
  return request({
    vue: this,
    url: '/video-forestry-baseservice/uavHorn/queryUavDevicesBySiteCode',
    method: 'post',
    data
  })
}
