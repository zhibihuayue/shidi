  ...
  >
    ...
    <template slot="reference">
      ...
      >
        ...
        <i
          v-if="circleClose"
          class="close_btn el-input__icon el-range__icon el-icon-circle-close"
          @click="clearDate"
        />
      </div>
    </template>
...
import { clickoutside, SELECT_STATE } from '../utils/index.js'
export default {
  name: 'YearPicker',
...
.el-date-editor .el-range__icon {
  ...
  height: px-to-rem(16);
  margin: 0 !important;
  background: url('~@component-gallery/ecosystemChanges/assets/image/imgIcon14.png')
    no-repeat;
